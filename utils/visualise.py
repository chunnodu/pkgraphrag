"""
visualise.py — PKG Ontology diagram generator
Reads pkg_ontology.ttl, outputs pkg_ontology.png
Run: python utils/visualise.py
"""
import os
import re
...
TTL_FILE = os.path.join(_ROOT, "pkg_ontology.ttl")
OUT_FILE = os.path.join(_ROOT, "pkg_ontology")  # .png appended by graphviz

PKG    = Namespace("https://pkg.chunnodu.com/ontology#")
SCHEMA = Namespace("https://schema.org/")


def build_diagram(ttl_file=TTL_FILE, out_file=OUT_FILE):
    g = Graph()
